        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm leading-relaxed opacity-70">
              Delivering fresh groceries to your doorstep in minutes. Quality you can trust, speed you'll love.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {[{ l: "Products", p: "/products" }, { l: "Categories", p: "/categories" }, { l: "Blog", p: "/blog" }, { l: "FAQ", p: "/faq" }].map(
                (item) => (
                  <Link
                    key={item.p}
                    to={item.p}
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {[{ l: "About Us", p: "/about" }, { l: "Contact", p: "/contact" }, { l: "Careers", p: "#" }, { l: "Privacy Policy", p: "#" }].map(
                (item) => (
                  <Link
                    key={item.l}
                    to={item.p}
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2 text-sm opacity-70">
                <Mail size={14} /> hello@freshly.app
              </div>
              <div className="flex items-center gap-2 text-sm opacity-70">
