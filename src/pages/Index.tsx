    ...
    <div className="container mx-auto px-4">
      <SectionHeader>
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/categories" className="text-primary text-sm font-medium flex items-center gap-1 hover:gap-2 transition-all">View All <ChevronRight size={16} /></Link>
        </div>
      </SectionHeader>
...
const FlashDealsSection = () => {
  const dealProducts = products.filter(p => p.discount >= 25);
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <SectionHeader>
...
const WhyChooseUsSection = () => {
  const features = [
    ...
    { icon: Truck, title: "Free Delivery", desc: "Free delivery on all orders above $15" },
        ...
        <motion.div ref={ref} initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }}>
          <div className="gradient-primary rounded-3xl p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-primary-foreground max-w-lg">
              ...
              <p className="text-primary-foreground/80 mb-6">Download now and get $10 off your first order. Experience grocery shopping like never before.</p>
